...
function parseTimestamp(value: string): number | null {
  ...
  if (![hours, minutes, secondsPart].every(Number.isFinite) || minutes < 0 || secondsPart < 0 || secondsPart >= 60) {
    return null
  }
...
export function validateTranscriptSegments(segments: TranscriptSegment[]): void {
